...
if exist classes.dex (
    ...
    adb shell "LD_LIBRARY_PATH=/system/lib64/:/data/local/tmp/ CLASSPATH=/data/local/tmp/classes.dex:/system/framework/uiautomator.jar app_process /data/local/tmp mfc.autopy.Entrance"
) else (
    del classes.jar
